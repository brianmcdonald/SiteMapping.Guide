...
![An example of a dummy site map composed in QGIS using the site map template included in this guide.<br> *Source: IOM*](/part3/images/dummy_site_map.png){.column-page-right width=70% }
