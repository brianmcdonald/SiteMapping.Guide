...
- Extract shelter outlines from aerial imagery using [Mapflow.ai](https://mapflow.ai/)'s built in deep learning and semantic segmentation models. After signing up, create a new project. Select your images and 
