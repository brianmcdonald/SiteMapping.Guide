...
%%| fig-width: 7.5
graph LR
    A[fa:fa-list Identify Requirements] 
    A --> B{fa:fa-arrows Decide on an approach}
    B -.-> C[fa:fa-globe Obtain Satellite Imagery]
    B -.-> D[fa:fa-map-pin Use UAV]
    C -.-> E[fa:fa-pencil Tracing & Labelling]
    D -.-> E
    E ---> F[fa:fa-map Compose Maps]
    F ---> G[fa:fa-users Collaboration]
```
