...
![An example of a *nadir* angle image of Wau PoC, in South Sudan<br> *Source: IOM*](/part2/images/wau2.jpg){.column-body-outset width=70% }

### Ground control points

![An example Ground Control Point<br> *Source: Pix4d*](/part2/images/gcp.jpg){.column-body-outset width=50% }
