...
**Software requirements** include: QGIS (or similar such as ArcGIS); WebODM (or similar such as PIX4D); DJI Fly mobile app; Dronelink mobile app (or similar for flight planning); Avenza Maps (or similar, for geoPDF usage) [^footnote1]
...
[^footnote1]: Where possible free and open source software is used in the process, in-line with the [UN Secretary General's Roadmap for Digital Cooperation](https://www.un.org/en/content/digital-cooperation-roadmap/) An exeption for this are the Dronlink app which is commercial and Avenza Maps which is free but with paid features.