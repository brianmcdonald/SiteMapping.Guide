...
**Software requirements** include: QGIS (or other GIS software like such as ArcGIS); DJI Fly mobile app; Dronelink mobile app (or similar for flight planning); WebODM (or other drone image processing tool such as PIX4D); Avenza Maps (or similar, for geoPDF usage) [^footnote5]
...
[^footnote5]: Where possible free and open source software is used in this mapping process, in-line with the [UN Secretary General's Roadmap for Digital Cooperation](https://www.un.org/en/content/digital-cooperation-roadmap/). An exception for this are the Dronelink app which is commercial and Avenza Maps which is free includes paid features.