...
In emergency contexts where drones or high resolution satellite imagery is not be available, producing site maps with a high level of accuracy can be very challenging. Depending on the intended use of the site map, other approaches exist to map out a site with lower accuracy. For example, maps of the site can be hand drawn onto large surfaces by either experienced site planners or members of the affected population. Whilst these maps may lack accurate spatial and geographic information, they can still be used for coordination purposes or as tools for focus group discussions. In both cases, the maps produced can carry significant value in informing assessments or supporting evidence based decision making and programming. However, low accuracy maps should not be used to conduct risk analysis such as flooding or fire hazard, and cannot be used for activities such as site planning.
